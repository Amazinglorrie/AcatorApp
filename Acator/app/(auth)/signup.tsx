        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <TouchableOpacity style={styles.loginLink} onPress={() => router.replace('/(auth)/login')}>
              <Text style={styles.loginLinkText}>Already have an account? <Text style={{ textDecorationLine: 'underline' }}>Sign in</Text></Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  logoArea: {
    ...
    gap: 12, paddingTop: 80, paddingBottom: 40,
  },
  logoMark: { width: 36, height: 42, position: 'relative' },
  logoLeft: {
    position: 'absolute', bottom: 0, left: 0,
    width: 5, height: 36, backgroundColor: '#fff',
    borderRadius: 3, transform: [{ rotate: '15deg' }],
  },
  logoCrossbar: {
    position: 'absolute', bottom: 14, left: 1,
    width: 22, height: 4, backgroundColor: 'rgba(255,255,255,0.7)',
  ...
  formTitle: { fontSize: 18, fontWeight: '500', color: '#fff', textAlign: 'center', marginBottom: 28 },
  fieldLabel: { fontSize: 13, color: 'rgba(255,255,255,0.85)', fontWeight: '500', marginBottom: 8 },
  inputWrap: {
